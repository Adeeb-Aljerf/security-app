import { Shield, Lock, AlertTriangle, FileSearch, UserCheck, MessageSquare } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h1 className="text-5xl font-bold text-indigo-600 mb-6">الحلول السريعة</h1>
          ...
          {solutions.map((solution, index) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="text-xl font-semibold text-center mb-4">{solution.title}</h3>
